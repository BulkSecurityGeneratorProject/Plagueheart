...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "Plagueheart@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "Plagueheart API";

        private String description = "Plagueheart API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "Plagueheart";
